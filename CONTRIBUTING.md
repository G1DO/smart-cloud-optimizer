...
[development guide](documentation/DEVELOPMENT.md) for checks and conventions and
the [documentation index](documentation/INDEX.md) to find technical references.
