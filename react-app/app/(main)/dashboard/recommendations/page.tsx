...
export default function RecommendationsPage() {
  ...
  const highPriorityCount =
    typeof apiSummary?.high_priority_count === "number"
      ? apiSummary.high_priority_count
    ...
    <div ref={wrapperRef} className={`${isDark ? "dashboard-dark" : ""}`}>
      <div className="recommendations-page">
        ...
        <section className="recommendations-kpi-grid">
          ...
          <article className="recommendations-kpi-card recommendations-kpi-card--high">
            <div className="recommendations-kpi-top">
            ...
            <p>
              {loading
                ? "..."
                : highPriorityCount === 0
                  ? "Matches current Streamlit data"
                  : "Priority mix returned from backend"}
            </p>
            <div className="recommendations-kpi-line" />
          </article>
        </section>
